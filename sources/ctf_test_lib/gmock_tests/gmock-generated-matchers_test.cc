...
MATCHER(IsEmptyString, "") {
	::jmsd::cutf::Static_assert_type_sameness< ::std::string, arg_type>();
	return arg == "";
}

MATCHER(IsEmptyStringByRef, "") {
  ::jmsd::cutf::Static_assert_type_sameness<const ::std::string&, arg_type>();
  return arg == "";
}
...
MATCHER_P3(ParamTypesAreIntLongAndChar, foo, bar, baz, "") {
  ::jmsd::cutf::Static_assert_type_sameness<int, foo_type>();
  ::jmsd::cutf::Static_assert_type_sameness<long, bar_type>();  // NOLINT
  ::jmsd::cutf::Static_assert_type_sameness<char, baz_type>();
  return arg == 0;
}
