...
void ReportInvalidTestSuiteType( char const* test_suite_name, ::testing::internal::CodeLocation code_location ) {
  ...
  GTEST_LOG_(ERROR) << ::testing::internal::FormatFileLocation(code_location.file.c_str(),
										  code_location.line)
					<< " " << errors.GetString();
}
}  // namespace internal
